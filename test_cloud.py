...
correct_num_lines_for_connectome_task = 432
...
if __name__ == "__main__":
    ...
    # TODO: add argparse for cloud v local, contactome v connectome v volume, and custom graph_id
    ...
    time.sleep(2)
    test_results(volume_graph_id, correct_num_lines_for_connectome_task)